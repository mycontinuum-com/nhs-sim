...
5. Open At home from the map and choose a resident by name or patient ID. Connect a simulated watch if they do not have one. Advance 15 minutes to receive the first activity reading; subsequent readings arrive hourly. Change resident to explore another person's records.
